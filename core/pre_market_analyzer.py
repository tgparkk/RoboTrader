...
from core import pre_market_sentiment
...
class PreMarketAnalyzer:
    ...
    def _calculate_sentiment_score(self) -> float:
        """심리 점수 계산 (core.pre_market_sentiment에 위임)."""
        return pre_market_sentiment.calculate_sentiment_score(self._snapshots)

    def _score_to_sentiment(self, score: float) -> str:
        """점수 → 심리 문자열 (core.pre_market_sentiment에 위임)."""
        return pre_market_sentiment.score_to_sentiment(score)

    def _calculate_expected_gap(self) -> float:
        """예상 갭 % (core.pre_market_sentiment에 위임)."""
        return pre_market_sentiment.calculate_expected_gap(self._snapshots)

    def _calculate_volatility_level(self) -> str:
        """변동성 수준 (core.pre_market_sentiment에 위임)."""
        return pre_market_sentiment.calculate_volatility_level(self._snapshots)
