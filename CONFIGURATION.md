...
```json
{
  ...
  "order_management": {
    ...
    "buy_budget_ratio": 0.19,          // 건당 투자 비율 (19%, closing_trade 최적값: 5종목 × 0.19 = 95%)
...
| 1/4 (0.25) | 275만원 | 수익/리스크 최적 (price_position 기준) |
| 1/5 (0.20) | 220만원 | 균형적 선택 (price_position 기준) |
| **0.19 (5종목 95%)** | 209만원 | **closing_trade 최적값 (현재)** — 시뮬 +53.7% / MDD 3.56% |
