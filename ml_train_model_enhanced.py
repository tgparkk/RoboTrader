#!/usr/bin/env python3
"""
확장된 특징(36개)으로 ML 모델 학습

입력: ml_dataset_enhanced.csv (11-12월, 36개 특징)
...
def load_and_prepare_data(csv_file: str = 'ml_dataset_enhanced.csv'):
    """데이터 로드 및 전처리"""
    print("=" * 70)
    print("📂 데이터 로드 중...")
    print("=" * 70)
...
def train_lightgbm_model(X_train, y_train, X_val, y_val, feature_names):
    """LightGBM 모델 학습"""
    print("\n" + "=" * 70)
    print("🚀 LightGBM 모델 학습 시작 (36개 특징)")
    print("=" * 70)
...
def save_model(model, feature_names, label_encoder, auc_score, filename='ml_model.pkl'):
    ...
    model_data = {
        ...
        'version': 'enhanced_36features',
        'trained_at': pd.Timestamp.now().isoformat(),
        'data_source': 'ml_dataset_enhanced.csv',
        'data_period': '2025-11-01 ~ 2025-12-31',
...
def main():
    ...
    print("=" * 70)
    print("\n생성된 파일:")
    print("  - ml_model.pkl (36개 특징 학습 모델)")
